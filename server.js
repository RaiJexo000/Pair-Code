...
async function lookupMovie(title) {
    try {
        const url = `http://www.omdbapi.com/?t=${encodeURIComponent(title)}&apikey=cf30df24&plot=short`;
        const response = await fetch(url);
        return await response.json();
    } catch (error) {
        return { error: error.message };
...
async function processCommand(command) {
    ...
    if (cmd === '.about') {
        return { message: `🤖 About OSINT TOOLBOX\n━━━━━━━━━━━━━━━━━━━━━━\n🕵️ OSINT TOOLBOX v2.0\n📌 WhatsApp OSINT Bot\n\nFeatures:\n• Phone/Vehicle/IFSC/IP Lookup\n• Weather/PIN/Snapchat/Aadhaar\n• Movies & Anime\n\n👨‍💻 BY @RaiJexo\n━━━━━━━━━━━━━━━━━━━━━━\nBY @RaiJexo` };
    }
...
// ==================== WHATSAPP CONNECTION - PAIRING CODE ONLY ====================
